...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('gUAUNLaR.orientaciNVocacional', {
    url: '/page178',
    views: {
      'side-menu21': {
  ...
  .state('gUAUNLaR.fotocopiadoraUNLaR', {
    url: '/page187',
    views: {
      'side-menu21': {
        templateUrl: 'templates/fotocopiadoraUNLaR.html',
        controller: 'fotocopiadoraUNLaRCtrl'
      }
    }
  })
